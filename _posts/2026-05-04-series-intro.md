...
<div class="moving-cover" markdown="0"><style>.moving-cover{position:relative;width:100%;max-width:360px;aspect-ratio:1080/1350;margin:1em auto .4em;border-radius:16px;overflow:hidden;background:#000;box-shadow:0 10px 34px rgba(0,0,0,.28);}.moving-cover .mc-lottie{position:absolute;inset:0;}.moving-cover .mc-grad{position:absolute;inset:0;background:linear-gradient(transparent 40%,rgba(0,0,0,.82) 84%,#000 100%);}.moving-cover .mc-text{position:absolute;left:7%;right:7%;bottom:9%;font-family:'Pretendard',-apple-system,sans-serif;}.moving-cover .mc-badge{display:inline-block;border:1.5px solid rgba(255,255,255,.45);border-radius:9999px;padding:5px 15px;font-size:.74rem;color:#fff;letter-spacing:.04em;margin-bottom:14px;}.moving-cover .mc-h{font-size:1.95rem;font-weight:800;line-height:1.14;color:#fff;letter-spacing:-.02em;}.moving-cover .mc-h .a{color:#F59E0B;display:block;}.moving-cover .mc-meta{margin-top:12px;font-size:.74rem;color:#A3A3A3;letter-spacing:.03em;}</style><div class="mc-lottie" id="mc-ep00"></div><div class="mc-grad"></div><div class="mc-text"><span class="mc-badge">자동화 연대기 | EP.00</span><div class="mc-h"><span class="a">나는 게을러서</span>자동화한다</div><div class="mc-meta">1주에 하나씩, 일상 자동화 · 2026</div></div></div>
<p style="text-align:center;font-size:.85em;color:#999;margin:0 0 1.6em;">↑ 표지가 움직입니다 · Lottie 벡터 애니메이션</p>
<script src="https://unpkg.com/lottie-web@5.12.2/build/player/lottie.min.js"></script>
<script>(function(){function go(){if(window.lottie&&document.getElementById('mc-ep00')){lottie.loadAnimation({container:document.getElementById('mc-ep00'),renderer:'svg',loop:true,autoplay:true,path:'/assets/lottie/ep00-cover.json'});}else{setTimeout(go,80);}}go();})();</script>
