...
excerpt: "> 한 줄로: 내가 Claude Code 위에 직접 만든 개인 자동화 하네스다. 폴더 하나가 작업자(워커) 한 명이고, 요청은 CLAUDE.md 라우팅표를 보고 맞는 워커로 바로 간다. 2026-09-23 v12 기준 워커 9 · 에이전트 8 · 스킬 7. 사무실에 비유하면 이렇다. 워커는 각자 자기 책상(폴더)에서 일하고, 서로 말을 걸지 않는다. 앞사람"
---
