...
## Key Facts
- **Adaptive Thinking**: 도구 호출 사이 추론 가능 (Interleaved Thinking) — Sonnet 4.6, Opus 4.7 [출처: sources/005-claude-4x-new-features.md]
- **Citations API**: 소스 문서 내 정확한 문장 자동 인용 — 전체 모델 [출처: sources/005-claude-4x-new-features.md]
- **Claude Code Routines**: 반복 작업 오프라인 스케줄링 자동화 [출처: sources/005-claude-4x-new-features.md]
- **1M Token Context (Beta)**: ~750,000단어 = ~2,500페이지 처리 — Sonnet 4.6, Opus 4.6 [출처: sources/005-claude-4x-new-features.md]
- **Managed Agents (Beta)**: 완전 관리형 에이전트 하네스, 보안 샌드박싱 포함 [출처: sources/005-claude-4x-new-features.md]
...
[출처: sources/005-claude-4x-new-features.md]
