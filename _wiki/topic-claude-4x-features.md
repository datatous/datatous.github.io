...
## Connections
- → [Harness Engineering](/wiki/concept-harness-engineering/) : 신기능이 하네스 설계에 미치는 영향
- → [12 Agentic Harness Patterns](/wiki/concept-12-harness-patterns/) : Routines = 패턴 #4 Dream Consolidation의 진화

## Open Questions
- Managed Agents (Beta): Henry 시스템이 자체 하네스를 유지할 가치가 있는가 vs. 완전 위임?
- Citations API 실제 연동 비용 측정 필요

<p class="wiki-sources"><b>근거 자료</b> <code>005-claude-4x-new-features.md</code></p>
