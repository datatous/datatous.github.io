...
## Summary
AI 개발 패러다임의 3세대. Agent = Model + Harness 공식으로, 하네스가 OS 역할을 수행한다. KV-cache hit rate가 프롬프트 품질을 대체하는 핵심 최적화 지표.
...
## Connections
- → [12 Agentic Harness Patterns](/wiki/concept-12-harness-patterns/) : 이 개념의 구체적 구현 패턴 목록
- → [Claude Code Architecture](/wiki/concept-claude-code-architecture/) : 권한/컴팩션 상세 구현
- → [Henry Agentic System](/wiki/entity-henry-agentic-system/) : Henry의 하네스 구현체
...
<p class="wiki-sources"><b>근거 자료</b> <code>001-harness-bits-bytes.md</code> · <code>003-wavespeed-claude-arch.md</code></p>
