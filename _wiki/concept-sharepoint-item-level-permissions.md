...
excerpt: "SharePoint 리스트에서 '여러 항목을 골라 한 번에 권한을 주는' 네이티브 기능은 없다. 권한은 항목마다 상속을 끊어 개별 부여하는 구조라, 다수 항목 제어는 자동화(Power Automate, PnP PowerShell)로만 가능하다. 더 중요한 건 이 방식이 성능·확장성 리스크가 큰 설계라는 점이다. 고유 보안 범위는 목록당 5,000개가 권장 "
---
...
- → [Henry Agentic System](/wiki/entity-henry-agentic-system/) : 컬럼값 기반 자동 부여는 "조건을 데이터에 두고 실행을
...
<p class="wiki-sources"><b>근거 자료</b> <code>011-sharepoint-item-level-permissions.md</code></p>
